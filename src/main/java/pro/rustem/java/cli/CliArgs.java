 ...
 * A command line argument parser implemented in Java. Use it to parse command line arguments passed to the main method of your Java application. Read how it works here:
 *
